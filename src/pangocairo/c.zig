...
// pub extern fn pango_cairo_show_layout_line(cr: ?*cairo.Context, line: ?*PangoLayoutLine) void;
...
// pub extern fn pango_cairo_layout_line_path(cr: ?*cairo.Context, line: ?*PangoLayoutLine) void;
// pub extern fn pango_cairo_layout_path(cr: ?*cairo.Context, layout: ?*PangoLayout) void;
